...
(setopt column-number-mode nil)                      ; Show column as well
...
;; general shortcuts
(load-file (expand-file-name "extras/general.el" user-emacs-directory))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes eat rainbow-delimiters rainbow-mode doom-modeline evil which-key)))
(custom-set-faces
